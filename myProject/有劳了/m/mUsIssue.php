...
<div class="login-content">
    <h2>请选择发布类型</h2>
    <div class="login-btn">
        <a href="<?php echo $root;?>m/mUser/mUsSupply.php" class="qq-btn"><span>发布劳务供给</span></a>
        <a href="<?php echo $root;?>m/mUser/mUsDemand.php" class="weibo-btn"><span>发布劳务需求</span></a>
    </div>
</div>
<!--底部-->
