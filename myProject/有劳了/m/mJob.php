...
if($num == 0){
	...
	while($array = mysql_fetch_assoc($query)){
		...
		$jobList .= "
    	<li class='po-co-item'><!--<input type='checkbox'>-->
    	<a href='{$root}m/mRecruit.php?demandMx_id={$array['id']}' class='clearfix po-text-box'>
            <h2 class='fl' style='padding-left:10px;'>{$array['title']}</h2>
            <span class='fr'>{$pay}</span>
    	</a>
    	</li>
		";	
	}
...
<div class='position-search-box'>
    <input name='searchJobKey' id='searchText' type='text' placeholder='请输入搜索关键词' value='' />
