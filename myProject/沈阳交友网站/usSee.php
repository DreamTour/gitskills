...
echo head("pc");
limit($kehu);
$sql = "select * from follow where type = '2' and TargetId = '$kehu[khid]' ";
			...
			<div class='content01_box'>
                    <div class='content01'>
                        ...
                        <div class='content_text'>
                            <span>到访：</span><span>".mb_substr($array['time'],0,10,'utf-8')."</span>
                        </div>
...
.page_number{width:70px;position:relative;top:-1px}
 ...
 <!--头部-->
    ...
    <div class="content">
        <!--位置-->
        <div class="news_place"><i class="news_place_icon" id="news_btn"></i><span>您所在的位置：</span><a href="<?php echo "{$root}user/user.php";?>">个人中心</a><span>>></span><a href="javascript:;">谁看过我</a></div>
        <!--谁看过我-->
        <div class="look_box">
