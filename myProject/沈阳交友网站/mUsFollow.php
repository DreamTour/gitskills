...
UserRoot("m");
limit($kehu);
$sql = mysql_query("select * from follow where type = '1' and TargetId = '$kehu[khid]' ");
$sqlNum = mysql_num_rows(mysql_query("select * from follow where type = '1' and TargetId = '$kehu[khid]' "));
$see = "";
if($sqlNum == 0){
	$see = "一个关注你的人都没有";		
}else{
