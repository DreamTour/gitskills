...
<div class="column MinHeight">
	...
	<div class="kuang">
		<p>
			...
			客户基本资料
            <a target="_blank" class="SpanButton FloatRight" href="<?php echo "{$root}searchMx.php?search_khid={$kehu['khid']} ";?>">预览</a>
		</p>
		...
		<table class="TableRight">
            ...
            <tr>
                <td>资料审核：</td>
                <td><?php echo select("ClientAuditing","select","--选择--",array("审核中","已通过","未通过"),$kehu['Auditing']);?></td>
            </tr>
		    <tr>
			    <td>更新时间：</td>
