...
<div class="column minheight">
	...
	<div class="kuang">
		<form name="Search" action="<?php echo "{$adroot}ku/adpost.php";?>" method="post">
			昵称：<input name="adClientNickName" type="text" class="text TextPrice" value="<?php echo $_SESSION['adClient']['NickName'];?>">
            ...
            <?php echo $Age2;?>
            <select name="province" class="select TextPrice">
                 <?php echo RepeatSele("region","province","--省份--");?>
            </select>
            <select name="city" class="select TextPrice">
                 <?php echo RepeatSele("region where province = '{$_SESSION['adClient']['province']}' ","city","--城市--");?>
            </select>
...
$(document).ready(function(){
	...
	KongSele("Search.province",$_SESSION['adClient']['province']).
	KongSele("Search.city",$_SESSION['adClient']['city']);
	?>
});
</script>
