...
while($array = mysql_fetch_array($Sql)){
	$img .= "<div class='deleteWrap' >
				...
				<i class='deleteIcon' style='cursor:pointer;' onClick=\"window.location.href='{$root}user/usPost.php?deletePhotoImg={$array['id']}'\"></i>
			</div>";
}
...
.personal,.personal_service{height:320px;border:1px solid #d4d4d4}
.personal_service{height:360px;}
