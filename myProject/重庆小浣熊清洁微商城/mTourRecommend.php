...
$result = mysql_query("SELECT DISTINCT classify FROM content WHERE type = '绿色重庆' AND xian='显示' ORDER BY list");
		    ...
		    <div class='tourism-title'>
		        <a href='{$root}m/mTour.php?classify={$classify}'>
		            <div class='mui-dis-flex'>
		                <label><em>{$classify}</em><i class='class-more'>&#xe61d;</i>
