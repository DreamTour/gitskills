...
function head($type,$title){
    if($type == "ad"){
		...
		<script type='text/javascript' charset='UTF-8' src='".root."control/ku/extend.js'></script>
		";
    }elseif($type == "pc"){
        $css = "<link rel='stylesheet' type='text/css' href='".root."library/pc.css'>";
        $js = "<script type='text/javascript' charset='UTF-8' src='".root."library/pc.js'></script>";
    }elseif($type == "m"){
        $css = "<link rel='stylesheet' type='text/css' href='".root."library/m.css'>";
        $js = "<script type='text/javascript' charset='UTF-8' src='".root."library/m.js'></script>";
        $meta = "
